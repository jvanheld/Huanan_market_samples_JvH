...
```{r racoon_dog, fig.width=8, fig.height=12, out.width="100%", fig.cap="Number of reads (log10-transformed) aligned on mitochondrial genome of selected species (abcsissa) versus SARS-CoV-2 (ordinate)."}
